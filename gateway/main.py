...
Responsibilities:
- Route /api/auth/*, /api/loan/*, /api/trust/*, /api/advisor/*, /api/fraud/*, and /api/monitor/* to downstream microservices
...
from routes import advisor_routes, auth_routes, fraud_routes, loan_routes, monitor_routes, trust_routes
